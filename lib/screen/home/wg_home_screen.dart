...
// State variables
  ...
  // Selected location
  String _selectedCountry = 'Select Location';
  ...
  Future<void> _loadConfigData() async {
    try {
      ...
      if (!config.trim().startsWith('[Interface]')) {
        ...
        Fluttertoast.showToast(
          msg: "Invalid server configuration. Please select another server.",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          backgroundColor: Colors.red,
          textColor: Colors.white,
  ...
  Future<void> _startVpn(String configContent) async {
    ...
    if (configContent.isEmpty || !configContent.trim().startsWith('[Interface]')) {
      Fluttertoast.showToast(
        msg: "Invalid WireGuard config. Cannot start VPN.",
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.BOTTOM,
        backgroundColor: Colors.red,
        textColor: Colors.white,
    ...
    try {
      ...
      if (isConnect) {
        ...
        if (!wgController.isGenerateSuccess) {
          ...
          Fluttertoast.showToast(
            msg: "Failed to generate client. Please try again.",
            backgroundColor: Colors.red,
            textColor: Colors.white,
          );
          setState(() {
        ...
        if (configContent == null || configContent.isEmpty) {
          ...
          Fluttertoast.showToast(
            msg: "Failed to generate client config.",
            backgroundColor: Colors.red,
            textColor: Colors.white,
          );
          setState(() {
          ...
          child: ListView(
            ...
            children: <Widget>[
                  ...
                  Get.dialog(
                    GetBuilder<ContactController>(
                      builder: (contactController) {
                        ...
                        if (contact == null) {
                          return const AlertDialog(
                            content: Text("No contact data available"),
                          );
                        }
              ...
              ListTile(
                ...
                onTap: () {
                  Get.to(() => const DynamicContentScreen(title: 'Privacy Policy', prefKey: 'privacy_policy'), transition: Transition.rightToLeft);
                },
              ),
              ...
              ListTile(
                ...
                onTap: () {
                  Get.to(() => const DynamicContentScreen(title: 'Terms & Conditions', prefKey: 'terms_conditions'), transition: Transition.rightToLeft);
                },
              ),
              ...
              ListTile(
                ...
                title: Text('About Us'),
                onTap: () {
                  Get.to(() => const DynamicContentScreen(title: 'About Us', prefKey: 'about_us'), transition: Transition.rightToLeft);
                },
              ),
                ...
                onTap: () async {
                  ...
                  if (url.isNotEmpty) {
                    ...
                    if (await canLaunchUrl(uri)) {
                      ...
                      Fluttertoast.showToast(msg: 'Cannot open URL', backgroundColor: Colors.red);
                    }
                  } else {
                    Fluttertoast.showToast(msg: 'No rate link available', backgroundColor: Colors.orange);
                  }
                },
              ),
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (shareUrl.isNotEmpty) {
                    ...
                    Fluttertoast.showToast(msg: 'Share link copied to clipboard', backgroundColor: Colors.green);
                  } else {
                    Fluttertoast.showToast(msg: 'No share link available', backgroundColor: Colors.orange);
                  }
                },
              ),
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (moreUrl.isNotEmpty) {
                    ...
                    Fluttertoast.showToast(msg: 'No link available', backgroundColor: Colors.orange);
                  }
                },
              ),
